...
extern "C" {
	...
	DLLEXPORT double mlp_model_predict_regression(MLP* mlp, double* inputs);
...
int main() {
	...
	//std::cout << mlp_model_predict_classification(model, inputs) << std::endl;
	//std::cout << std::endl;
	...
	std::cout << mlp_model_predict_classification(model, &(inputs[6])) << std::endl;
